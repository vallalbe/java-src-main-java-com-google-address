...
public class AddressConverter {
  ...
  */
    ...
    public static String getAddress(String latlon) {
        String result = null;
        GoogleResponse res1 = null;
        try {
            res1 = new AddressConverter().convertFromLatLong(latlon);
            if (res1.getStatus().equals("OK")) {
                int i = 0;
                for (Result res : res1.getResults()) {
                    if (i == 1) {
                        result = res.getFormatted_address();
                    }
                    i++;
                }
            } else {
    ...
    public static void main(String[] args) throws IOException {
      ...
      /*  GoogleResponse res = new AddressConverter().convertToLatLong("south street ,periyakattupalayam,panruti," +
        ...
        System.out.println("\n");
        GoogleResponse res1 = new AddressConverter().convertFromLatLong("13.771599,75.594563");
        if (res1.getStatus().equals("OK")) {
            int i = 0;
   ...
   */
        URL url = new URL(URL + "?latlng="
                + URLEncoder.encode(latlongString, "UTF-8") + "&sensor=true");
        // Open the Connection
        URLConnection conn = url.openConnection();
